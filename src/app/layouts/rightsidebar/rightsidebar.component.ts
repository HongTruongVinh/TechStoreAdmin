...
import { changelayoutTheme, changeMode, changeposition, changepreLoader, changesidebarcolor, changesidebarImage, changesidebarView, changesize, changeTheme, changetopbar, changewidthLayout } from '../../store/layouts/layout-action';
import { getLayout, getLayoutmode, getLayoutTheme, getLayoutWidth, getPosition, getPreloader, getSidebarcolor, getsidebarimage, getSidebarsize, getsidebarview, getTopbar } from '../../store/layouts/layout-selector';
